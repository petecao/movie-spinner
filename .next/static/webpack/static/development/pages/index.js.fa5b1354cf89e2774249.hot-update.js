  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(TextBox, [{
    ...
    value: function spinWheel() {
      if (this.state.movies.length > 0 && !this.wheelSpun) {
        ...
        this.setState({
          imgsrc: "http://image.tmdb.org/t/p/w500/" + movieJSON.results[0].poster_path + "class=img-responsive"
        });
        this.wheelSpun = true;
      }
    }
...
//# sourceMappingURL=index.js.fa5b1354cf89e2774249.hot-update.js.map